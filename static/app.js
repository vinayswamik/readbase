...
const indexForm = mustQuery("#indexForm");
const repoUrlInput = mustQuery("#repoUrl");
const refreshRepoInput = mustQuery("#refreshRepo");
const indexButton = mustQuery("#indexButton");
const repoStatus = mustQuery("#repoStatus");
const repoList = mustQuery("#repoList");
const askForm = mustQuery("#askForm");
const questionInput = mustQuery("#question");
const askButton = mustQuery("#askButton");
const messages = mustQuery("#messages");
const llmMode = mustQuery("#llmMode");
...
indexForm.addEventListener("submit", async (event) => {
    ...
    try {
        ...
        const result = await postJson("/api/index", {
            repo_url: repoUrl,
...
async function loadRepos() {
    try {
        const result = await fetchJson("/api/repos");
...
function appendMessage(role, text, sources = [], mode = "retrieval") {
